---
name: cuihuo
description: 淬火 - 观点淬硬引擎，一套文风，两种产物。产物一「想法硬文」：把一个技术观点直抒胸臆写成对外发布的专业硬文，给同行看，观点大于行文、平实克制、精确概念直接说不套比喻、一节只讲一个观点讲清就走绝不车轱辘话、篇幅服从观点不凑字数、姿态平视不宣称，适合发朋友圈接受专业人士考验。产物二「锻造手记」：把一个想法或一篇文章提炼成 120 字以内的平实短思考，沉淀进个人笔记文档。触发词：写想法文、写硬文、直抒胸臆、观点文、淬火、观点淬硬、专业硬文、去AI味写、删车轱辘话、一节一观点；以及 记一笔、锻造手记、AI思考。DO NOT USE WHEN：技术调研/把新东西讲透（走 feynman-explainer）；天马行空畅想文如 Token 战争、AGI 畅想（走 tangshan-style 汤山体）；纯翻译、纯润色。
---
...
废话之外，最该警惕的第二类毛病是**词不配位**：随手抓一个听着有力的词，套到一个它根本不该形容的对象上。读着别扭、经不起推敲，专业人士一眼看穿你没想清楚。

### 硬规则（踩一条就改）

1. **动词/形容词必须配得上主语。** 一个词能不能用，先问"这个词本来是形容什么的，眼前这个对象属不属于那一类"。**账**会亏空、算不过来、亏、补不上，但账不会"绷"、不会"崩"（绷的是皮筋、是弦，崩的是堤坝、是弦）；**趋势**会延续、会逆转，但趋势不会"塌陷"。词和物对不上，就是硬伤，换一个配得上的。
...
> 这条只管**呈现形式**，不改变"事实必须有出处"的要求。核心是两件事分开：**长标题挪到文末，链接留在正文角标上**。别一挪标题把链接也带走了——那是最常犯的错。
...
- 适合配图：收支剪刀差、成本砍九成、占比 95%、抚养比 2.6:1 这类**一眼能看出悬殊**的数据。
...
淬火最容易翻车、也最招专业人士反感的，不是观点错，而是**废话多、车轱辘话**：一个观点，换个说法反复说、正着说一遍反着说一遍、举完例子再总结一遍、一两句能说清的事非要铺成很多句。铁律一句话钉死：**能一两句说清的判断，绝不铺成很多句；每一句存在，都必须有它不可替代的必要性，删掉它文章就变弱。** 一篇拧巴、废话多的稿子，非专业人士看着头疼，专业人士看着更头疼——他一眼就看穿你在凑、在扯。

> ⚠️ 这条红线管的是**语义层的啰嗦**，机械扫标点、扫「不是X而是Y」查不出来它，必须靠逐句人工过。**这是淬火区别于普通写作的核心：淬火 = 语言精炼到极致，一个字的废话都不留。**
...
7. **交付**：默认同时给**Markdown 正文 + 可发布版本**。强对比数据配文生图更直观。
